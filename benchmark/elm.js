...
var _user$project$Benchmark_Stats$onlineVariance = function (vals) {
	var step = F2(
		function (x, _p0) {
			...
			var delta = x - _p2;
			var n_ = _p1._0 + 1;
			var mean_ = _p2 + (delta / _elm_lang$core$Basics$toFloat(n_));
			var m2_ = _p1._2 + (delta * (x - mean_));
			return {ctor: '_Tuple3', _0: n_, _1: mean_, _2: m2_};
		});
	var _p3 = A3(
		_elm_lang$core$List$foldl,
		step,
				...
				A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(e.suite),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(e.benchmark),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Benchmark results'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Benchmark_Program$viewPlatform(model.platform),
				_1: {
					ctor: '::',
					_0: _user$project$Benchmark_Program$viewResults(model),
					_1: {
						ctor: '::',
						_0: _user$project$Benchmark_Program$viewErrors(model.errors),
						_1: {
							ctor: '::',
							_0: _user$project$Benchmark_Program$viewStatus(model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$NewRandom$mul32 = F2(
	function (a, b) {
		var bl = b & 65535;
		var bh = 65535 & (b >>> 16);
		var al = a & 65535;
...
var _user$project$NewRandom$onSelfMsg = F3(
	function (_p1, _p0, seed) {
		return _elm_lang$core$Task$succeed(seed);
	});
var _user$project$NewRandom$step = F2(
	function (_p2, seed) {
		var _p3 = _p2;
		return _p3._0(seed);
	});
var _user$project$NewRandom$onEffects = F3(
	function (router, commands, seed) {
		var _p4 = commands;
		if (_p4.ctor === '[]') {
			return _elm_lang$core$Task$succeed(seed);
		} else {
			var _p5 = A2(_user$project$NewRandom$step, _p4._0._0, seed);
			var value = _p5._0;
			var newSeed = _p5._1;
			return A2(
				_elm_lang$core$Task$andThen,
				function (_p6) {
					return A3(_user$project$NewRandom$onEffects, router, _p4._1, newSeed);
				},
				A2(_elm_lang$core$Platform$sendToApp, router, value));
		}
	});
var _user$project$NewRandom$peel = function (_p7) {
	var _p8 = _p7;
	var _p9 = _p8._0;
	var word = (_p9 ^ (_p9 >>> ((_p9 >>> 28) + 4))) * 277803737;
	return ((word >>> 22) ^ word) >>> 0;
};
var _user$project$NewRandom$listHelp = F4(
	function (list, n, generate, seed) {
		listHelp:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(n, 1) < 0) {
				...
				var _p10 = generate(seed);
				var value = _p10._0;
				var newSeed = _p10._1;
				var _v3 = {ctor: '::', _0: value, _1: list},
					_v4 = n - 1,
					_v5 = generate,
					_v6 = newSeed;
				list = _v3;
...
var _user$project$NewRandom$minInt = -2147483648;
var _user$project$NewRandom$maxInt = 2147483647;
var _user$project$NewRandom$command = _elm_lang$core$Native_Platform.leaf('NewRandom');
var _user$project$NewRandom$Seed = function (a) {
	return {ctor: 'Seed', _0: a};
};
var _user$project$NewRandom$next = function (_p11) {
	var _p12 = _p11;
	return _user$project$NewRandom$Seed(((_p12._0 * 1664525) + 1013904223) >>> 0);
};
var _user$project$NewRandom$initialSeed = function (x) {
	var _p13 = _user$project$NewRandom$next(
		_user$project$NewRandom$Seed(0));
	var state1 = _p13._0;
	var state2 = (state1 + x) >>> 0;
	return _user$project$NewRandom$next(
		_user$project$NewRandom$Seed(state2));
};
var _user$project$NewRandom$init = A2(
	_elm_lang$core$Task$andThen,
	function (t) {
		return _elm_lang$core$Task$succeed(
			_user$project$NewRandom$initialSeed(
				_elm_lang$core$Basics$round(t)));
	},
	_elm_lang$core$Time$now);
var _user$project$NewRandom$Generator = function (a) {
	return {ctor: 'Generator', _0: a};
};
var _user$project$NewRandom$int = F2(
	function (a, b) {
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p14 = (_elm_lang$core$Native_Utils.cmp(a, b) < 0) ? {ctor: '_Tuple2', _0: a, _1: b} : {ctor: '_Tuple2', _0: b, _1: a};
				var lo = _p14._0;
				var hi = _p14._1;
				var range = (hi - lo) + 1;
				if (_elm_lang$core$Native_Utils.eq((range - 1) & range, 0)) {
					return {
						ctor: '_Tuple2',
						_0: (((range - 1) & _user$project$NewRandom$peel(seed0)) >>> 0) + lo,
						_1: _user$project$NewRandom$next(seed0)
					};
				} else {
					...
					var accountForBias = function (seed) {
						accountForBias:
						while (true) {
							var seedN = _user$project$NewRandom$next(seed);
							var x = _user$project$NewRandom$peel(seed);
...
var _user$project$NewRandom$float = F2(
	function (a, b) {
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var range = _elm_lang$core$Basics$abs(b - a);
				var n0 = _user$project$NewRandom$peel(seed0);
				var hi = _elm_lang$core$Basics$toFloat(67108863 & n0) * 1.0;
				var seed1 = _user$project$NewRandom$next(seed0);
				var n1 = _user$project$NewRandom$peel(seed1);
				...
				return {
					ctor: '_Tuple2',
					_0: scaled,
					_1: _user$project$NewRandom$next(seed1)
				};
			});
	});
var _user$project$NewRandom$list = F2(
	function (n, _p15) {
		var _p16 = _p15;
		return _user$project$NewRandom$Generator(
			function (seed) {
				return A4(
					_user$project$NewRandom$listHelp,
					{ctor: '[]'},
					n,
					_p16._0,
					seed);
...
var _user$project$NewRandom$map = F2(
	function (func, _p17) {
		var _p18 = _p17;
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p19 = _p18._0(seed0);
				var a = _p19._0;
				var seed1 = _p19._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$NewRandom$bool = A2(
	_user$project$NewRandom$map,
	F2(
		function (x, y) {
			return _elm_lang$core$Native_Utils.eq(x, y);
		})(1),
	A2(_user$project$NewRandom$int, 0, 1));
var _user$project$NewRandom$map2 = F3(
	function (func, _p21, _p20) {
		var _p22 = _p21;
		var _p23 = _p20;
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p24 = _p22._0(seed0);
				var a = _p24._0;
				var seed1 = _p24._1;
				var _p25 = _p23._0(seed1);
				var b = _p25._0;
				var seed2 = _p25._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$NewRandom$pair = F2(
	function (genA, genB) {
		return A3(
			_user$project$NewRandom$map2,
			F2(
				function (v0, v1) {
					return {ctor: '_Tuple2', _0: v0, _1: v1};
				}),
...
var _user$project$NewRandom$map3 = F4(
	function (func, _p28, _p27, _p26) {
		var _p29 = _p28;
		var _p30 = _p27;
		var _p31 = _p26;
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p32 = _p29._0(seed0);
				var a = _p32._0;
				var seed1 = _p32._1;
				var _p33 = _p30._0(seed1);
				var b = _p33._0;
				var seed2 = _p33._1;
				var _p34 = _p31._0(seed2);
				var c = _p34._0;
				var seed3 = _p34._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$NewRandom$map4 = F5(
	function (func, _p38, _p37, _p36, _p35) {
		var _p39 = _p38;
		var _p40 = _p37;
		var _p41 = _p36;
		var _p42 = _p35;
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p43 = _p39._0(seed0);
				var a = _p43._0;
				var seed1 = _p43._1;
				var _p44 = _p40._0(seed1);
				var b = _p44._0;
				var seed2 = _p44._1;
				var _p45 = _p41._0(seed2);
				var c = _p45._0;
				var seed3 = _p45._1;
				var _p46 = _p42._0(seed3);
				var d = _p46._0;
				var seed4 = _p46._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$NewRandom$map5 = F6(
	function (func, _p51, _p50, _p49, _p48, _p47) {
		var _p52 = _p51;
		var _p53 = _p50;
		var _p54 = _p49;
		var _p55 = _p48;
		...
		return _user$project$NewRandom$Generator(
			function (seed0) {
				var _p57 = _p52._0(seed0);
				var a = _p57._0;
				var seed1 = _p57._1;
				var _p58 = _p53._0(seed1);
				var b = _p58._0;
				var seed2 = _p58._1;
				var _p59 = _p54._0(seed2);
				var c = _p59._0;
				var seed3 = _p59._1;
				var _p60 = _p55._0(seed3);
				var d = _p60._0;
				var seed4 = _p60._1;
				var _p61 = _p56._0(seed4);
				var e = _p61._0;
				var seed5 = _p61._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$NewRandom$andThen = F2(
	function (callback, _p62) {
		var _p63 = _p62;
		return _user$project$NewRandom$Generator(
			function (seed) {
				var _p64 = _p63._0(seed);
				var result = _p64._0;
				var newSeed = _p64._1;
				var _p65 = callback(result);
				var genB = _p65._0;
				return genB(newSeed);
			});
	});
var _user$project$NewRandom$Generate = function (a) {
	return {ctor: 'Generate', _0: a};
};
var _user$project$NewRandom$generate = F2(
	function (tagger, generator) {
		return _user$project$NewRandom$command(
			_user$project$NewRandom$Generate(
				A2(_user$project$NewRandom$map, tagger, generator)));
	});
var _user$project$NewRandom$cmdMap = F2(
	function (func, _p66) {
		var _p67 = _p66;
		return _user$project$NewRandom$Generate(
			A2(_user$project$NewRandom$map, func, _p67._0));
	});
_elm_lang$core$Native_Platform.effectManagers['NewRandom'] = {pkg: 'user/project', init: _user$project$NewRandom$init, onEffects: _user$project$NewRandom$onEffects, onSelfMsg: _user$project$NewRandom$onSelfMsg, tag: 'cmd', cmdMap: _user$project$NewRandom$cmdMap};

var _user$project$Main$n = 1000;
var _user$project$Main$nseed = _user$project$NewRandom$initialSeed(141053960);
var _user$project$Main$oseed = _elm_lang$core$Random$initialSeed(141053960);
var _user$project$Main$mySuite = A2(
	_user$project$Benchmark$suite,
	'Random number suite',
	{
		ctor: '::',
		_0: A2(
			...
			'OLD: flip a coin',
			function (_p0) {
				return A2(_elm_lang$core$Random$step, _elm_lang$core$Random$bool, _user$project$Main$oseed);
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				'NEW: flip a coin',
				function (_p1) {
					return A2(_user$project$NewRandom$step, _user$project$NewRandom$bool, _user$project$Main$nseed);
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_user$project$Main$n),
							' coins')),
					function (_p2) {
						return A2(
							_elm_lang$core$Random$step,
							A2(_elm_lang$core$Random$list, _user$project$Main$n, _elm_lang$core$Random$bool),
							_user$project$Main$oseed);
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						function (_p3) {
							return A2(
								_user$project$NewRandom$step,
								A2(_user$project$NewRandom$list, _user$project$Main$n, _user$project$NewRandom$bool),
								_user$project$Main$nseed);
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Benchmark$bench,
							'OLD: generate an integer 100-200',
							function (_p4) {
								return A2(
									_elm_lang$core$Random$step,
									A2(_elm_lang$core$Random$int, 100, 200),
									_user$project$Main$oseed);
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Benchmark$bench,
								'NEW: generate an integer 100-200',
								function (_p5) {
									return A2(
										_user$project$NewRandom$step,
										A2(_user$project$NewRandom$int, 100, 200),
										_user$project$Main$nseed);
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Benchmark$bench,
									'OLD: generate an integer 0-4094',
									function (_p6) {
										return A2(
											_elm_lang$core$Random$step,
											A2(_elm_lang$core$Random$int, 0, 4094),
											_user$project$Main$oseed);
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Benchmark$bench,
										'NEW: generate an integer 0-4094',
										function (_p7) {
											return A2(
												_user$project$NewRandom$step,
												A2(_user$project$NewRandom$int, 0, 4094),
												_user$project$Main$nseed);
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$Benchmark$bench,
											'OLD: generate an integer 0-4095',
											function (_p8) {
												return A2(
													_elm_lang$core$Random$step,
													A2(_elm_lang$core$Random$int, 0, 4095),
													_user$project$Main$oseed);
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_user$project$Benchmark$bench,
												'NEW: generate an integer 0-4095',
												function (_p9) {
													return A2(
														_user$project$NewRandom$step,
														A2(_user$project$NewRandom$int, 0, 4095),
														_user$project$Main$nseed);
												}),
											_1: {
												ctor: '::',
												_0: A2(
													_user$project$Benchmark$bench,
													'OLD: generate an integer 0-4096',
													function (_p10) {
														return A2(
															_elm_lang$core$Random$step,
															A2(_elm_lang$core$Random$int, 0, 4096),
															_user$project$Main$oseed);
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_user$project$Benchmark$bench,
														'NEW: generate an integer 0-4096',
														function (_p11) {
															return A2(
																_user$project$NewRandom$step,
																A2(_user$project$NewRandom$int, 0, 4096),
																_user$project$Main$nseed);
														}),
													_1: {
														ctor: '::',
														_0: A2(
															_user$project$Benchmark$bench,
															'OLD: generate a massive integer',
															function (_p12) {
																return A2(
																	_elm_lang$core$Random$step,
														...
														_1: {
															...
															_0: A2(
																_user$project$Benchmark$bench,
																'NEW: generate a massive integer',
																function (_p13) {
																	return A2(
																		_user$project$NewRandom$step,
																		A2(_user$project$NewRandom$int, 0, 4294967295),
																		_user$project$Main$nseed);
																}),
															_1: {
																ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		_user$project$Benchmark$bench,
																		'NEW: generate a percentage',
																		function (_p15) {
																			return A2(
																				_user$project$NewRandom$step,
																				A2(_user$project$NewRandom$float, 0, 1),
																				_user$project$Main$nseed);
																		}),
																	_1: {
																		ctor: '::',
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_0: A2(
																					_user$project$Benchmark$bench,
																					'OLD: generate an float 100-200',
																					function (_p18) {
																						return A2(
																							_elm_lang$core$Random$step,
																							A2(_elm_lang$core$Random$float, 100, 200),
																							_user$project$Main$oseed);
																					}),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						_user$project$Benchmark$bench,
																						'NEW: generate an float 100-200',
																						function (_p19) {
																							return A2(
																								_user$project$NewRandom$step,
																								A2(_user$project$NewRandom$float, 100, 200),
																								_user$project$Main$nseed);
																						}),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_user$project$Benchmark$bench,
																							'OLD: generate a float 0-4094',
																							function (_p20) {
																								return A2(
																									_elm_lang$core$Random$step,
																									A2(_elm_lang$core$Random$float, 0, 4094),
																									_user$project$Main$oseed);
																							}),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_user$project$Benchmark$bench,
																								'NEW: generate a float 0-4094',
																								function (_p21) {
																									return A2(
																										_user$project$NewRandom$step,
																										A2(_user$project$NewRandom$float, 0, 4094),
																										_user$project$Main$nseed);
																								}),
																							_1: {
																								ctor: '::',
																								_0: A2(
																									_user$project$Benchmark$bench,
																									'OLD: generate a float 0-4095',
																									function (_p22) {
																										return A2(
																											_elm_lang$core$Random$step,
																											A2(_elm_lang$core$Random$float, 0, 4095),
																											_user$project$Main$oseed);
																									}),
																								_1: {
																									ctor: '::',
																									_0: A2(
																										_user$project$Benchmark$bench,
																										'NEW: generate a float 0-4095',
																										function (_p23) {
																											return A2(
																												_user$project$NewRandom$step,
																												A2(_user$project$NewRandom$float, 0, 4095),
																												_user$project$Main$nseed);
																										}),
																									_1: {
																										ctor: '::',
																										_0: A2(
																											_user$project$Benchmark$bench,
																											'OLD: generate a float 0-4096',
																											function (_p24) {
																												return A2(
																													_elm_lang$core$Random$step,
																													A2(_elm_lang$core$Random$float, 0, 4096),
																													_user$project$Main$oseed);
																											}),
																										_1: {
																											ctor: '::',
																											_0: A2(
																												_user$project$Benchmark$bench,
																												'NEW: generate a float 0-4096',
																												function (_p25) {
																													return A2(
																														_user$project$NewRandom$step,
																														A2(_user$project$NewRandom$float, 0, 4096),
																														_user$project$Main$nseed);
																												}),
																											_1: {
																												ctor: '::',
																												_0: A2(
																													_user$project$Benchmark$bench,
																													'OLD: generate a massive float',
																													function (_p26) {
																														return A2(
																															_elm_lang$core$Random$step,
																															A2(_elm_lang$core$Random$float, 0, 4294967295),
																															_user$project$Main$oseed);
																													}),
																												_1: {
																													ctor: '::',
																													_0: A2(
																														_user$project$Benchmark$bench,
																														'NEW: generate a massive float',
																														function (_p27) {
																															return A2(
																																_user$project$NewRandom$step,
																																A2(_user$project$NewRandom$float, 0, 4294967295),
																																_user$project$Main$nseed);
																														}),
																													_1: {ctor: '[]'}
																												}
...
var _user$project$Main$main = _user$project$Benchmark_Program$program(
	{
		ctor: '::',
		_0: _user$project$Main$mySuite,
		_1: {ctor: '[]'}
	})();
